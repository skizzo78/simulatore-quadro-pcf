...
#define pin_sp 10       // startpermit     
#define pin_porta 9  //  porta cabina                      
#define pin_co 3  //  controllo teleruttori porte (elmi)                     
#define pin_fcc 2  //  finecorsa chiusura                     
#define pin_fca 1  //  finecorsa apertura                      
...
bool set = EEPROM.read(0);    //   0 epb    1 systemlift - elmi     2 OTIS LB"
...
void simulazione() {
  ...
  if (millis() - previousMillis >= 100) { // trasmetto al display ogni 100Ms
    ...
    if (!av) {
      display.setTextSize(2); display.setCursor(40, 0); display.print("AV");
    }
    if (!bv) {
