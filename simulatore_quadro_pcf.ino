//scritto da Moratelli Denis   aggiornato il 22/01/2024
...
int set_stop = EEPROM.read(1);  // 0 = stop senza av/bv  1 = run anche senza av/bv
...
void loop() {
  ...
  switch (stato) {
    ...
    case 231: sub_menu_tipo_systemlift_oleo(); break;
    case 232: sub_menu_tipo_systemlift_2v(); break;
    case 233: sub_menu_tipo_systemlift_3vf(); break;
...
void simulazione() {
  ...
  int key = readkey();
  switch (key) {
    case 2: pos = ++pos; delay(500); break;
    case 3: pos = --pos; delay(500); break;
  }
  ...
  if (s == 0 && pos < 500) {  //attivo salita e
    ...
    if (millis() - millis_tempo > vel) {
      ...
      if (set_stop == 0 && (av == 1 && bv == 1)) { pos = --pos; }  //funzione che blocca movimento senza av/bv
    }
  }
...
void menu_exit() {
  if (attesa) {
    ...
    display.println("ATTENDERE PREGO");
    display.display();
    attesa = false;
    delay(4000);
  }
  ...
  switch (key) {
    case 1:
      EEPROM.update(0, set);
      EEPROM.update(1, set_stop);
      disp2;
      display.setCursor(0, 10);
      display.println("SALVO IN  EEPROM");
      display.display();
      delay(4000);
      setStato(0);
      break;
...
void sub_menu_tipo_systemlift_oleo() {
  ...
  switch (key) {
    case 1:
      ...
      setStato(2);
      break;
    case 2: setStato(233); break;
    case 3: setStato(232); break;
  }
}
...
void sub_menu_tipo_systemlift_2v() {
  ...
  switch (key) {
    case 1:
      ...
      setStato(2);
      break;
    case 2: setStato(231); break;
    case 3: setStato(233); break;
  }
}
...
void sub_menu_tipo_systemlift_3vf() {
  ...
  switch (key) {
    case 1:
      ...
      setStato(2);
      break;
    case 2: setStato(232); break;
    case 3: setStato(231); break;
  }
}
